...
public abstract class Innlegg {
	...
	public Innlegg(int id, String bruker, String dato) {
		...
		// Initsialiserer objektvariablene med de argumentene som er gitt i
		// konstruktøren
	...
	// Metode for å sjekke om et innlegg er likt / har samme id som et annet
	// innlegg.
	...
	public String toString() {
		// Bygger opp strengen på formatet som kreves ved hjelp av objektvariablenes
		// verdier.
		String s = id + "\n" + bruker + "\n" + dato + "\n" + likes + "\n";
		// returnerer strengen.
		return s;
