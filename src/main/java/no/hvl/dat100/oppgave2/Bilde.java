...
public class Bilde extends Tekst {
	...
	// Oppretter en ny objektvariabel url som protected i tilfelle den trengs av en
	// subklasse senere.
	protected String url;

	// Initsialiserer konstruktørene slik som de forrige klassene, nå bare med url
	// varaiabel i tillegg
